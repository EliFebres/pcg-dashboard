...
const mockHotTickers: HotTicker[] = [
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 43 }, { quarter: 'Q4 2024', requests: 52 }],
    trend: '+18%',
    dfaCompetitor: 'DFAS',
  ...
  },
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 41 }, { quarter: 'Q4 2024', requests: 47 }],
    trend: '+12%',
    dfaCompetitor: 'DFUS',
  ...
  },
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 35 }, { quarter: 'Q4 2024', requests: 38 }],
    trend: '+8%',
    dfaCompetitor: 'DFUS',
    dfaName: 'US Core Equity 1',
  ...
  },
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 27 }, { quarter: 'Q4 2024', requests: 31 }],
    trend: '+15%',
    dfaCompetitor: 'DFAI',
  ...
  },
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 29 }, { quarter: 'Q4 2024', requests: 28 }],
    trend: '-3%',
    dfaCompetitor: 'DFCF',
  ...
  },
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 23 }, { quarter: 'Q4 2024', requests: 24 }],
    trend: '+5%',
    dfaCompetitor: 'DFAI',
    dfaName: 'Intl Core Equity',
  ...
  },
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 16 }, { quarter: 'Q4 2024', requests: 21 }],
    trend: '+22%',
    dfaCompetitor: 'DFLV',
  ...
  },
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 18 }, { quarter: 'Q4 2024', requests: 19 }],
    trend: '+7%',
    dfaCompetitor: 'DFAE',
  ...
  },
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 17 }, { quarter: 'Q4 2024', requests: 17 }],
    trend: '-1%',
    dfaCompetitor: 'DFCF',
    dfaName: 'Core Fixed Income',
  ...
  },
  {
    ...
    quarterlyRequests: [{ quarter: 'Q3 2024', requests: 10 }, { quarter: 'Q4 2024', requests: 15 }],
    trend: '+31%',
    dfaCompetitor: 'DFUS',
    dfaName: 'US Core Equity 1',
