...
interface TickerNotesModalProps {
  isOpen: boolean;
  onClose: () => void;
  ticker: string;
  tickerName: string;
...
const TickerNotesModal: React.FC<TickerNotesModalProps> = ({
  isOpen,
  onClose,
  ticker,
  tickerName,
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-zinc-900 border border-zinc-700/50 shadow-2xl">
        ...
        <div className="relative z-10 px-5 py-4 border-b border-zinc-800/50 flex items-center justify-between">
          <div>
            <h2 className="text-base font-medium text-white">Ticker Notes</h2>
...
export default TickerNotesModal;
